...
const Entertainment = () => {
  const categoryData = getObjectsOfSameCategory(mockBlogData, "entertainment");
  ...
  return (
    <div>
      <div
        className={`category-heading bg-[#FFCE54] text-white py-20 px-10 md:px-16`}
      >
        <CategoryHeading category="entertainment" />
      </div>
