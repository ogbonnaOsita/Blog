...
const Health = () => {
  const categoryData = getObjectsOfSameCategory(mockBlogData, "health");
  ...
  return (
    <div>
      <div
        className={`category-heading bg-[#4Fc1E8] text-white py-20 px-10 md:px-16`}
      >
        <CategoryHeading category="health" />
      </div>
