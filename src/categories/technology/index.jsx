...
const Technology = () => {
  const categoryData = getObjectsOfSameCategory(mockBlogData, "technology");
  ...
  return (
    <div>
      <div
        className={`category-heading bg-[#ED5564] text-white py-20 px-10 md:px-16`}
      >
        <CategoryHeading category="technology" />
      </div>
