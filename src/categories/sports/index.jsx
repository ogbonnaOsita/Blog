...
const Sports = () => {
  const categoryData = getObjectsOfSameCategory(mockBlogData, "sports");
  ...
  return (
    <div>
      <div
        className={`category-heading bg-[#A0D568] text-white py-20 px-10 md:px-16`}
      >
        <CategoryHeading category="sports" />
      </div>
